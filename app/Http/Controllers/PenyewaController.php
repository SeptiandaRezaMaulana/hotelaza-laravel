...
class PenyewaController extends Controller
{
    ...
    {
        $client     = new Client();
        $request    = $client->get('http://localhost/pesanHotel/server/api/penyewa');
    ...
    {
        $client     = new Client();
        $request    = $client->get('http://localhost/pesanHotel/server/api/penyewa/id_penyewa=' . $id);
        $response   = $request->getBody();
    ...
    {
        $client = new Client();
        $client->request('POST', 'http://localhost/pesanHotel/server/api/penyewa', [
            'form_params' => [
